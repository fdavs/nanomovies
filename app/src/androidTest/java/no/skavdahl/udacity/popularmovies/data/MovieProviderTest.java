...
public class MovieProviderTest extends AndroidTestCase {
	...
	public void testProviderRegistration() {
		...
		assertEquals(
			"Content provider registered with authority '" + providerInfo.authority + "' " +
			"instead of the expected authority '" + MovieContracts.CONTENT_AUTHORITY + "'",
			providerInfo.authority, MovieContracts.CONTENT_AUTHORITY);
	}
}
